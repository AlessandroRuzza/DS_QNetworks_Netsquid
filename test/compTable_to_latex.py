...
def convert_comparison_table_to_latex(text_table: str) -> str:
    ...
    latex_lines = [
        ...
        r"\hline",
        r"\textbf{Scenario} & \textbf{Distance} & \textbf{Method} & \textbf{Avg Time} & \textbf{Avg} & \textbf{$P_{gen}$} & \textbf{Secret Key} \\",
        r" & \textbf{(km)} &  & $T_\mathrm{units}$} & \textbf{Fidelity} &  & \textbf{Rate} $[keys/T_\mathrm{unit}]$ \\",
        r"\hline"
    ]
...
Scenario                       Distance     Method               Avg Time Units     Avg Fidelity    P_gen      Secret-Key Rate   
------------------------------------------------------------------------------------------------------------------------------------------
Zero length loss fibre          10km         Repeater             2.67               1.0000          0.5000     0.374532
                                             Direct               1.97               1.0000          0.5000     0.507614
------------------------------------------------------------------------------------------------------------------------------------------
Zero length loss fibre          40km         Repeater             2.65               1.0000          0.5000     0.377358
                                             Direct               2.01               1.0000          0.5000     0.497512
------------------------------------------------------------------------------------------------------------------------------------------
High length loss fibre          10km         Repeater             2.31               1.0000          0.5623     0.432900
                                             Direct               3.09               1.0000          0.3162     0.323625
------------------------------------------------------------------------------------------------------------------------------------------
Low-Noise fibre                 10km         Repeater             1.52               0.9510          0.7943     0.144200
(ideal mem)                                  Direct               1.61               0.9510          0.6310     0.152200
------------------------------------------------------------------------------------------------------------------------------------------
===========================================================================================================================================
"""
